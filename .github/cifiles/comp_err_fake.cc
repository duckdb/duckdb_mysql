...
static const char *OUTFILE = "mysqld_error.h";


static void usage() {
  printf(
      "Usage: ./comp_err --header_file=name\n");
}


int main(int argc, char *argv[]) {
  const char *error_file = R"MYSQLERRFILE(/* Copyright (c) 2000, 2023, Oracle and/or its affiliates.
...
static const int errmsg_section_size[] = { 888, 239, 660, 3999 };

static const int total_error_count = 5786;
...
#define ER_IB_INDEX_LOADER_DONE 13997
#define ER_IB_INDEX_BUILDER_DONE 13998
static const int obsolete_error_count = 543;

static const int pfs_no_error_stat_count = 2;

static const int pfs_session_error_stat_count = 1634;

static const int pfs_global_error_stat_count = 3607;
  ...
  for(size_t i = 0; i < argc; i++) {
    ...
    if (arg.rfind("--header_file=") == 0) {
      out_file = arg.substr(14);
    }
  }
