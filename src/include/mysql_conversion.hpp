...
struct DecimalConversionInteger {
	...
	template <class T>
	static T Finalize(const MySQLDecimalConfig &config, T result) {
		return result;
	}
};
...
struct DecimalConversionHugeint {
	...
	static hugeint_t Finalize(const MySQLDecimalConfig &config, hugeint_t result) {
		return result;
	}
};
...
struct DecimalConversionDouble {
	...
	static double Finalize(const MySQLDecimalConfig &config, double result) {
