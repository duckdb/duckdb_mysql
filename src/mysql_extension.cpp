...
static void LoadInternal(DatabaseInstance &db) {
	...
	// LogicalType::BOOLEAN, Value::BOOLEAN(true)); 	config.AddExtensionOption("pg_pages_per_task", "The amount of
	// pages per task", LogicalType::UBIGINT, Value::UBIGINT(MySQLBindData::DEFAULT_PAGES_PER_TASK));
